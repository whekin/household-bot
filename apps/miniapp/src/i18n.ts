...
export const dictionary = {
  ...
  ru: {
    ...
    balancesUtilitiesPaidBody: 'Ты полностью оплатил свою долю коммуналки за этот цикл.',
    ...
    quickPurchaseHeroBody:
      'Начни с обычного сценария: ты оплатил, участвуют все, и покупка сразу появится в домашней ленте.',
    ...
    todayCloseMyUtilities: 'Я оплатил коммуналку',
    todayCloseMyRent: 'Я оплатил аренду',
