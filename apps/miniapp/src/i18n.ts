...
export const dictionary = {
  en: {
    ...
    homeIdleComparisonTitle: 'How you compare across the house',
    ...
    absencePolicyHint: 'Sets how rent and utilities are counted across the selected date range.',
    absenceStartDateLabel: 'Absence start date',
    absenceEndDateLabel: 'Absence end date',
    absenceEndDateHint: 'Leave empty for an open-ended interval.',
    absenceIntervalSummaryLabel: 'Billing interval preview',
    ...
    utilityParticipationDaysLabel: 'Utility days this cycle',
  ...
  ru: {
    ...
    homeIdleComparisonTitle: 'Как это выглядит по дому',
    ...
    absencePolicyHint: 'Определяет, как аренда и коммуналка считаются в выбранном диапазоне дат.',
    absenceStartDateLabel: 'Дата начала отсутствия',
    absenceEndDateLabel: 'Дата окончания отсутствия',
    absenceEndDateHint: 'Оставь пустым, если период открыт.',
    absenceIntervalSummaryLabel: 'Превью интервала начислений',
    ...
    utilityParticipationDaysLabel: 'Дней участия в коммуналке в этом цикле',
