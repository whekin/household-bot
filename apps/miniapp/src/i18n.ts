...
export const dictionary = {
  ...
  ru: {
    ...
    homeIdlePurchaseBalanceExplainValue: 'Позиция по общим покупкам',
    homeIdlePurchaseBalanceExplainBody:
    ...
    balancesUtilitiesPaidBody: 'Твоя доля коммуналки за этот цикл полностью закрыта.',
    ...
    balancesFormulaTitle: 'Формула сейчас',
    ...
    homeQuickActionsBody: 'Покупки и журнал под рукой, когда они действительно нужны.',
    ...
    householdBalancesBody: 'Кто должен, у кого закрыто и у кого остался кредит в этом цикле.',
    balancesTitle: 'Текущий баланс',
    balancesSubtitle: 'Все категории',
    purchasesBalanceTitle: 'Покупки',
    purchasesBalanceBody:
      'Показывает плательщиков общих покупок и как это меняет баланс каждого участника.',
    ...
    quickPurchaseHeroTitle: 'Зафиксируй общую трату, пока она не забылась',
    quickPurchaseHeroBody:
      'Начни с обычного сценария: плательщик выбран, участвуют все, и покупка сразу появится в домашней ленте.',
    quickPurchaseSheetTitle: 'Быстро добавить покупку',
    quickPurchaseSheetBody:
      'Сохрани общую покупку за несколько секунд. Полный журнал нужен только если разделение требует деталей.',
    quickPurchaseSplitEveryone: 'Все',
    quickPurchaseSplitCustom: 'Выбрать участников',
    quickPurchasePeopleLabel: 'Кто участвует',
    quickPurchaseMoreOptions: 'Больше настроек',
    quickPurchaseLessOptions: 'Меньше настроек',
    ...
    quickPurchasePreviewBody:
      'Предварительно показывает, как эта покупка повлияет на баланс участников.',
    quickPurchasePreviewBefore: 'Сейчас',
    quickPurchasePreviewAfter: 'Потом',
    ...
    todayUtilitiesBody: 'Коммуналка остаётся открытой, пока не записаны оплаты по плану.',
    todayRentBody: 'Аренда остаётся открытой, пока не закрыты оставшиеся чеки.',
    todayIdleBody: 'Сейчас окно оплат закрыто. Покупки остаются под рукой.',
    ...
    todayUtilityCarryForwardCreditLabel: 'Перенос прошлых периодов',
    todayUtilityPlanTargetLabel: 'Цель плана',
    ...
    todayHouseOpenLabel: 'Открытые чеки',
    todayAdminToolsTitle: 'Инструменты админа',
    todayAdminToolsBody: 'Закрыть оставшиеся чеки по плану для всего дома.',
    todayLeftToClose: 'Осталось закрыть',
    todayProgressLabel: 'Прогресс периода',
    todayExtendedPeriod: 'Продлённый период',
    todayYourCheck: 'Твой чек',
    todayNoPaymentWindow: 'Сейчас без оплат',
    todayHouseStillOpen: 'Ещё открыто по дому',
    todayOpenChecks: 'Открытые чеки',
    todayClosedChecks: 'Закрыто',
    todayCloseMyUtilities: 'Закрыть коммуналку',
    todayCloseMyRent: 'Закрыть аренду',
    ...
    todayPurchaseDebit: 'Ты должен по общим покупкам.',
    todayPurchaseEven: 'По общим покупкам всё ровно.',
    todayPurchasesEmpty: 'Покупок пока нет.',
    todayPurchaseCommandTitle: 'Покупки, которыми удобно управлять',
    todayPurchaseCommandBody: 'Последние покупки, твой баланс и быстрый вход в полный журнал.',
    todayOpenPurchasesLabel: 'В расчёте',
    todayPurchaseVolumeLabel: 'Записано в цикле',
    todayPurchaseChartLabel: 'Позиции по общим покупкам',
    todayPurchaseChartValueLabel: 'Сальдо',
    todayPurchasePositionCredit: 'Покрыл больше',
    todayPurchasePositionDebit: 'Нужно вернуть',
    todayPurchasePositionEven: 'Ровно',
    todayMyShare: 'моя доля',
    todayCurrentPeriod: 'Текущий цикл',
    todayOpen: 'открыто',
    todayQuietPanel: 'Все оплаты закрыты. Можно добавить покупки или проверить дом.',
    todayOpenChecksTitle: 'Кто ещё не закрыт',
    todayOpenChecksBody: 'Свой чек можно закрыть сразу. Админ может закрыть и остальных.',
    todayYouLabel: 'ты',
    todayTapToClose: 'Нажми, чтобы закрыть',
    todayWaitingForMember: 'Ждём',
    todayDone: 'Закрыто',
    todayAdminConfirmTitle: 'Закрыть период',
    todayAdminConfirmBody: 'Запишем оплаты по плану для всех, кто ещё не закрыт.',
    todayAdminConfirmAction: 'Закрыть всех',
    todayCloseSuccess: 'Оплата закрыта',
    ...
    rentPaymentOpenLink: 'Открыть ссылку оплаты аренды',
    ...
    unresolvedPurchasesTitle: 'Покупки в расчёте',
    resolvedPurchasesTitle: 'Закрытые покупки',
    unresolvedPurchasesEmpty: 'Все покупки уже сведены.',
