export const en = {
  ...
  householdFactsTitle: 'Household facts',
  householdFactsBody:
    'Answers the bot gives to non-money questions: Wi-Fi, door codes, trash days, landlord. Members can also teach it facts from chat.',
  householdFactsEmpty: 'No facts stored yet',
  householdFactAddAction: 'Add fact',
  householdFactRemoveAction: 'Remove',
  householdFactKeyLabel: 'Key',
  householdFactKeyHint: 'Latin letters, digits and dashes, e.g. wifi',
  householdFactTitleLabel: 'Title',
  householdFactBodyLabel: 'Answer',
  householdFactsSaveError: 'Failed to save household facts.',
  ...
  monthlyRentOverridesTitle: 'Monthly rent',
  monthlyRentOverridesHint:
    'Adjust this cycle or prepare the next one without changing the default.',
  currentRentPeriod: 'Current cycle',
  nextRentPeriod: 'Next cycle',
  useDefaultRentAction: 'Use default rent',
  loadingRentPeriods: 'Loading next cycle…',
  rentPeriodsLoadError: 'Failed to load next cycle rent.',
...
export const ru: Record<keyof typeof en, string> = {
  ...
  householdFactsTitle: 'Факты о доме',
  householdFactsBody:
    'Ответы бота на неденежные вопросы: вайфай, домофон, вывоз мусора, хозяин. Участники также могут диктовать факты прямо в чате.',
  householdFactsEmpty: 'Фактов пока нет',
  householdFactAddAction: 'Добавить факт',
  householdFactRemoveAction: 'Удалить',
  householdFactKeyLabel: 'Ключ',
  householdFactKeyHint: 'Латиница, цифры и дефисы, например wifi',
  householdFactTitleLabel: 'Название',
  householdFactBodyLabel: 'Ответ',
  householdFactsSaveError: 'Не получилось сохранить факты о доме.',
  ...
  monthlyRentOverridesTitle: 'Аренда по месяцам',
  monthlyRentOverridesHint:
    'Измени текущий цикл или подготовь следующий, не меняя сумму по умолчанию.',
  currentRentPeriod: 'Текущий цикл',
  nextRentPeriod: 'Следующий цикл',
  useDefaultRentAction: 'Вернуть сумму по умолчанию',
  loadingRentPeriods: 'Загружаем следующий цикл…',
  rentPeriodsLoadError: 'Не получилось загрузить аренду следующего цикла.',
