          ...
          <div class="admin-grid">
            <article class="balance-item">
              <header>
                ...
                <span>{props.cycleState?.cycle?.period ?? props.copy.billingCycleEmpty ?? ''}</span>
              </header>
              <p>
          ...
          >
            <div class="editor-grid">
              ...
              <Field label={props.copy.paymentBalanceAdjustmentPolicy ?? ''} wide>
                ...
                >
                  <option value="utilities">{props.copy.paymentBalanceAdjustmentUtilities}</option>
                  ...
                  {(category) => (
                    <article class="ledger-compact-card">
                      <div class="ledger-compact-card__main">
                        ...
                        <p>{props.copy.utilityCategoryName ?? ''}</p>
                        <div class="ledger-compact-card__meta">
                          <span class={`mini-chip ${category.isActive ? '' : 'mini-chip--muted'}`}>
            ...
            footer={(() => {
              ...
              return (
                <div class="modal-action-row">
                  <Button variant="danger" onClick={() => void props.onDeleteUtilityBill(bill.id)}>
            ...
            <article class="balance-item admin-card--wide">
              ...
              <div class="balance-list admin-sublist">
                <For each={['purchase', 'feedback', 'reminders', 'payments'] as const}>
                  {(role) => {
                    const binding = props.adminSettings?.topics.find((topic) => topic.role === role)
